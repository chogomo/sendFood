...
export const RECEIVE_USER_INFO = 'receive_user_info' //接收用戶訊息
...
export const DECREMENT_FOOD_COUNT = 'decrement_food_count' //減少food中的count值
export const CLEAR_CART = 'clear_cart' //清空購物車

export const RECEIVE_SEARCH_SHOP = 'receive_search_shops'//接收搜索商家數組
