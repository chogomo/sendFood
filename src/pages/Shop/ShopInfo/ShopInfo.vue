    ...
    <div class="shop-info">>
        <div class="info-content">
            ...
            <section class="section">
                ...
                <ul class="detail">
                    <li><span class="bold">品類:</span> <span>{{info.category}}</span></li>
                    <li><span class="bold">商家電話:</span> <span>{{info.phone}}</span></li>
                    <li><span class="bold">地址:</span> <span>{{info.address}}</span></li>
                    <li><span class="bold">營業時間:</span> <span>{{info.workTime}}</span></li>
                </ul>
            </section>
        </div>
    </div>
